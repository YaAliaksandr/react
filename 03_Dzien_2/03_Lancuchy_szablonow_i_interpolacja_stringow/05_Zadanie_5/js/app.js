...
const textCreater = function () {
	...
	buttonContainerRef.innerHTML = `<button style="width:${button.width}px; padding:${button.padding}px;" id="${button.id}" >${button.text}</button>`
	// we can doo also after innerHtml
